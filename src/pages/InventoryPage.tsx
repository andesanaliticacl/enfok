...
import { Wallet, ShoppingCart, Dumbbell, Plus, Trash2, TrendingUp, TrendingDown } from 'lucide-react'
...
function FinanceSection() {
  ...
  const balance = financeEntries.reduce((sum, e) => sum + (e.type === 'ingreso' ? e.amount : -e.amount), 0)
